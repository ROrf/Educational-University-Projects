...
-- 3pts
func_1c :: [(String, Int)]
func_1c = [("Ten points for Gryffindor!", 10)]

-- 3pts
func1_d :: [a] -> a
func1_d [] = error "Error: Please provide a non-empty list"
func1_d arg1 = head arg1

-- 3pts
func_1e :: a -> [(a, a)]
func_1e arg1 = [(arg1, arg1)]

-- 3pts
func_1f :: (a, b) -> (b, a)
func_1f (arg1, arg2) = (arg2, arg1)

-- 3pts
func_1g :: (Integer -> Integer -> Integer) -> Integer -> Integer -> Integer
func_1g f x1 x2 = x1 * x2 - x2 + (f x1 x2)
...
-- 4 pts
func_2a :: [a] -> [a]
func_2a as = if ((length as) >= 2) then (drop 2 (as ++ [(as !! 0), (as !! 1)])) else (as)
-- Resource used to reference list functions (length, drop, value at an index, appending to the end): https://wiki.haskell.org/How_to_work_on_lists
...
func_2b :: [a] -> a
func_2b [] = error "ERROR"
func_2b as = if((length as) >= 2) then (as !! ((length as) - 2)) else (head as)
-- Resource used to reference list functions (length, drop, value at an index): https://wiki.haskell.org/How_to_work_on_lists
...
-- Resource used to reference list comprehension syntax: https://wiki.haskell.org/List_comprehension
...
-- 4 pts
-- func_2d :: ????
func_2d :: Int -> arg1 -> [arg1]
func_2d n s = if(n > 0) then(replicate n s) else([s])
-- Resource used to reference replicate function: https://hoogle.haskell.org/?hoogle=replicate
...
-- func_2e :: ?????
func_2e :: [arg1] -> [arg1]
func_2e list = foldr duplicateTwice [] list where duplicateTwice arg1 arg2 = arg1 : arg1 : arg1 : arg2
-- Resource used to reference foldr syntax: http://zvon.org/other/haskell/Outputprelude/foldr_f.html
...
func_3b [] _ = []
func_3b str n = if(n >= 0) then (rotateString str n) else (error "error")

rotateString :: String -> Integer -> String
rotateString str n = if(n > 0) then (rotateString ((str !! ((length str) - 1)):(init str)) (n-1)) else (str)
-- Resource used to reference 'appending to the beginning of a list' syntax: https://stackoverflow.com/questions/33441306/adding-something-to-the-beginning-of-a-list-with-operator-in-haskell
